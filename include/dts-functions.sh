...
# dts-environment.sh and board_config function.
  ...
  case "$SYSTEM_VENDOR" in
    ...
    "Dell Inc.")
      ...
      SINIT_ACM_URL="https://openxt.ainfosec.com/OpenXT/mirror/${SINIT_ACM_FILENAME}"
      SINIT_ACM_HASH="1e888aebc78d637d119c489adffa95387b53429125dc3ad61f10a5cad0496834 $SINIT_ACM_FILENAME"
