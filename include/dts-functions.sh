...
board_config() {
  ...
  "HARDKERNEL")
    ...
    *)
    ...
    BIOS_LINK_DPP_SLIMUEFI="${BUCKET_DPP_SLIMUEFI}/${DASHARO_REL_NAME}/v${DASHARO_REL_VER_DPP_SLIMUEFI}/${DASHARO_REL_NAME}_v${DASHARO_REL_VER_DPP_SLIMUEFI}_slim_booloader_uefi.rom"
    ;;
  "QEMU" | "Emulation")
    case "$SYSTEM_MODEL" in
    *Q35*ICH9* | *q35*ich9*)
